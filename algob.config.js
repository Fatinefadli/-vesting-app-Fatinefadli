...
let accounts = mkAccounts([
  ...
  },
  {
    ...
    addr: process.env.VUE_APP_ACC3_ADDR,
    mnemonic: process.env.VUE_APP_ACC3_MNEMONIC,
  },
  {
  ...
  {
    name: "Team",
    addr: process.env.VUE_APP_ACC4_ADDR,
    mnemonic: process.env.VUE_APP_ACC4_MNEMONIC,
  }
]);
